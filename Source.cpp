	...
	do {
		...
		if (cin >> userChoice)//read user choice
		{
			...
			case 1:
				...
				cout << "\n";
				CallProcedure("freq") ; // call the frequency function	
				cout << "\n";
				break;
			case 2:
				...
				cout << "\n";
				break;
			case 3:  // This case produces a text-based histogram fro,
				cout << "Produce a text-based histogram listing all items purchased in a given day, & their frequency.";
				cout << "\n";
				CallProcedure("histogram");// call the text-based histogram function	
				cout << "\n";
				break;
			case 4:
				cout << "Thank you";
		...
		while (userChoice != 4); //quit when user picks option 4, stops loop
